          ...
          <div className="p-6">
            <div className="flex flex-wrap items-center">
              <div className="flex-basis w-full shrink-0 grow-0 px-3 lg:w-5/12">
                <img src=""
                  alt="RRA Logo" className="mb-6 dark:brightness-150 lg:mb-0" />
              </div>
              <div className="flex-basis w-full shrink-0 grow-0 px-3 lg:w-7/12">
                <h5 className="mb-4 font-bold">RRA</h5>
                <ul className="mb-0 flex list-inside flex-row">
                  ...
                  <a href="#!" className="px-2">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                      className="h-3.5 w-3.5 text-neutral-500 dark:text-neutral-300">
                      <path fill="currentColor"
        ...
        <div
          ...
          <div className="p-6">
            <div className="flex flex-wrap items-center">
              <div className="flex-basis w-full shrink-0 grow-0 px-3 lg:w-5/12">
                <img src=""
                  alt="BK Logo" className="mb-6 dark:brightness-150 lg:mb-0" />
              </div>
              <div className="flex-basis w-full shrink-0 grow-0 px-3 lg:w-7/12">
                <h5 className="mb-4 font-bold">Bank of Kigali</h5>
                <ul className="mb-0 flex list-inside flex-row">
                  <a href="#!" className="pr-2">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-neutral-500 dark:text-neutral-300"
                      fill="currentColor" viewBox="0 0 24 24">
        ...
        <div
          ...
          <div className="p-6">
            <div className="flex flex-wrap items-center">
              <div className="flex-basis w-full shrink-0 grow-0 px-3 lg:w-5/12">
                <img src=""
                  alt="Logo" className="mb-6 dark:brightness-150 lg:mb-0" />
              </div>
              <div className="flex-basis w-full shrink-0 grow-0 px-3 lg:w-7/12">
                <h5 className="mb-4 font-bold">RwandaAir</h5>
                <ul className="mb-0 flex list-inside flex-row">
                  <a href="#!" className="pr-2">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-neutral-500 dark:text-neutral-300"
                      fill="currentColor" viewBox="0 0 24 24">
